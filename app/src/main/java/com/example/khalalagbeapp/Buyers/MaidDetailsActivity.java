...
import java.util.HashMap;
 ...
 public class MaidDetailsActivity extends AppCompatActivity {
    ...
    private  String maid_PhoneNumber = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // maid_PhoneNumber= getIntent().getStringExtra("maid_PhoneNumber");
       ...
       // getMaidDetails(maid_PhoneNumber);
     ...
     private void addingToCartList()
     {
        ...
        final  DatabaseReference cartListRef =FirebaseDatabase.getInstance().getReference().child("Cart List");
         ...
         cartMap.put("maid_PhoneNumber",maid_PhoneNumber);
         ...
         maidsRef.child(maidID).addValueEventListener(new ValueEventListener() {
             ...
             public void onDataChange(@NonNull DataSnapshot snapshot)
             {
                 if (snapshot.exists())
                 {
                     ...
                     maid_PhoneNumber = maids.getMaid_PhoneNumber();
