...
public class AdminAddNewMaidActivity extends AppCompatActivity {
    ...
    private String categoryName, Description,PresentAddress,Mname,Price1,Price2,Price3,saveCurrentDate, saveCurrentTime,PhoneNumber,productState = "Approved";
  ...
  private   DatabaseReference MaidsRef;
   private ProgressDialog loadingBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputMaidNumber= findViewById(R.id.maid_phone_number1);

        AddNewMaidButton = findViewById(R.id.add_new_maid1);
        maidInfoPic = findViewById(R.id.infoPic1);
        InputMaidInfoImage = findViewById(R.id.select_maid_info_image1);
        InputMaidName  = findViewById(R.id.maid_name1);
        InputMaidPresentAddress  = findViewById(R.id.maid_present_Address1);
        InputMaidDescription  = findViewById(R.id.maid_description1);
        InputMaidPrice1  = findViewById(R.id.maid_price_category11);
        InputMaidPrice2  = findViewById(R.id.maid_price_category21);
        InputMaidPrice3  = findViewById(R.id.maid_price_category31);
    ...
    private void SaveMaidInfoToDatabase()
    {
        ...
        MaidMap.put("productState",productState);
        ...
        MaidsRef.child(maidRandomKey).updateChildren(MaidMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if(task.isSuccessful())
                        {
                            Intent intent = new Intent(AdminAddNewMaidActivity.this, AdminHomeActivity.class);
